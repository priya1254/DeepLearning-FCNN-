function [net, info] = Fourlabel_last_decoder_AE_1to1_IVUS_L2_3B_LReLU_IpBN_withAug(imdb, inpt)
    ...
    net.addLayer('unpool2x_M1_T1', dagnn.Unpooling(), {'relu3x', 'pool2_indices_M1', 'sizes_pre_pool2_M1', 'sizes_post_pool2_M1'}, {'unpool2x_M1_T1'}, {});
...
%     net.addLayer('drop', dagnn.DropOut('rate', 0.5), {'relu7'}, {'drop'}, {});
 ...
 % Decoder Block 2 label2
    net.addLayer('unpool2x_M1_T2', dagnn.Unpooling(), {'relu3x', 'pool2_indices_M1', 'sizes_pre_pool2_M1', 'sizes_post_pool2_M1'}, {'unpool2x_M1_T2'}, {});
 ...
 % Decoder Block 2 label3
    net.addLayer('unpool2x_M1_T3', dagnn.Unpooling(), {'relu3x', 'pool2_indices_M1', 'sizes_pre_pool2_M1', 'sizes_post_pool2_M1'}, {'unpool2x_M1_T3'}, {});
 ...
 % Decoder Block 2 label4
    net.addLayer('unpool2x_M1_T4', dagnn.Unpooling(), {'relu3x', 'pool2_indices_M1', 'sizes_pre_pool2_M1', 'sizes_post_pool2_M1'}, {'unpool2x_M1_T4'}, {});
 ...
 % Decoder Block 2 label5
    net.addLayer('unpool2x_M1_T5', dagnn.Unpooling(), {'relu3x', 'pool2_indices_M1', 'sizes_pre_pool2_M1', 'sizes_post_pool2_M1'}, {'unpool2x_M1_T5'}, {});
